export const Mutation = `
  type Mutation {
    ...
    addScoring(mpm: Int, wrong_words: Int, correct_letters: Int, total_letters: Int, wrong_letters: Int, precision: Float, points: Int, type: String, userId: String, gameId: String): Score!
