...
export const MainContext = React.createContext<{
  ...
  setWordsStack: React.Dispatch<React.SetStateAction<Array<string>>>,
  ...
  setHorizontalPosition: React.Dispatch<React.SetStateAction<number | undefined>>,
  letterWidth: number | undefined,
  setLetterWidth: React.Dispatch<React.SetStateAction<number | undefined>>,
  fontSize: number,
  language: string,
