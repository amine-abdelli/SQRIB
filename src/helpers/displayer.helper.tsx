import * as words from '../dictionnaries/fr/words.json';
import * as pronouns from '../dictionnaries/fr/pronouns.json';
import * as articles from '../dictionnaries/fr/articles.json';
